...
/*   Updated: 2025/03/17 19:25:13 by f4t4lity         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    printf("Comparando \"%s\" e \"%s\": %d\n", str1, str4, ft_strcmp(str1, str4)); // Deve imprimir um valor negativo
    printf("Comparando \"%s\" e \"%s\": %d\n", str4, str1, ft_strcmp(str4, str1)); // Deve imprimir um valor positivo
